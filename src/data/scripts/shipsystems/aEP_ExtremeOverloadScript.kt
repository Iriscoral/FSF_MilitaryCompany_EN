...
class aEP_ExtremeOverloadScript : BaseShipSystemScript() {
  ...
  companion object {
    ...
    const val FLUX_PERCENT_TO_OVERLOAD_TIME = 0.15f //how many percent accumulated flux of total flux convert to 1 second overload
  ...
  override fun apply(stats: MutableShipStatsAPI, id: String, state: ShipSystemStatsScript.State, effectLevel: Float) {
    ...
    //计算应该过载多久
    overloadTime = if (accumulatedFlux.total > ship.fluxTracker.maxFlux * FLUX_PERCENT_TO_OVERLOAD_TIME * MAX_OVERLOAD_TIME) MAX_OVERLOAD_TIME else accumulatedFlux.total / (FLUX_PERCENT_TO_OVERLOAD_TIME * ship.fluxTracker.maxFlux)
